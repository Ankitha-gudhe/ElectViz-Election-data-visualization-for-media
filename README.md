...
Overview
ElectViz is an interactive data visualization project designed to present election results in a clear, engaging, and media-friendly format. It transforms raw election data into meaningful insights using dashboards and visual analytics.
